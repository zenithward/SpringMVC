...
<head>
  ...
  <link rel="resource/stylesheet" href="resource/css/jquery.jqzoom.css" type="text/css">
  ...
  <script src="resource/js/jquery.jqzoom-core.js" ></script>
       ...
       <div id="sidebar" class="grid_3">
	      ...
	      <aside id="specials" class="specials">
		     ...
		     <ul>
			    <li>
				   <div class="prev">
					  <a href="#"><img src="resource/images/special1.png" alt="" title="" /></a>
				   </div>
			    ...
			    <li>
				   <div class="prev">
					  <a href="#"><img src="resource/images/special2.png" alt="" title="" /></a>
				   </div>
		...
		<div class="list_carousel">
			<ul id="list_banners">
				<li class="banner"><a href="#">
					<div class="prev">
						<img src="resource/images/banner.png" alt="" title="" />
					</div><!-- .prev -->
       ...
       <div id="content" class="grid_9">
		...
		<div class="product_page">
			<div class="grid_4 img_slid" id="products">
				<img class="sale" src="resource/images/sale.png" alt="Sale"/>
				<div class="preview slides_container">
					<div class="prev_bg">
						<a href="resource/images/produkt_slid.png" class="jqzoom" rel='gal1' title="">
							<img src="resource/images/produkt_slid.png"  title="" alt=""/>
						</a>
					</div>
				</div><!-- .prev -->

				<ul class="pagination clearfix" id="thumblist">
					<li><a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './resource/images/produkt_slid.png',largeimage: './resource/images/produkt_slid.png'}"><img src='resource/images/produkt_slid.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './resource/images/produkt_slid1.png',largeimage: './resource/images/produkt_slid1.png'}"><img src='resource/images/produkt_slid1.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './resource/images/produkt_slid2.png',largeimage: './resource/images/produkt_slid2.png'}"><img src='resource/images/produkt_slid2.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './resource/images/produkt_slid3.png',largeimage: './resource/images/produkt_slid3.png'}"><img src='resource/images/produkt_slid3.png' alt=""></a></li>
					<li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './resource/images/produkt_slid4.png',largeimage: './resource/images/produkt_slid4.png'}"><img src='resource/images/produkt_slid4.png' alt=""></a></li>
				</ul>
			...
			<div class="grid_5">
				<div class="entry_content">
					...
					<div class="soc">
						<img src="resource/images/soc.png" alt="Soc"/>
					</div><!-- .soc -->
				</div><!-- .entry_content -->
				...
				<ul id="list_product" class="list_product">
					<li class="">
						<div class="grid_3 product">
							<img class="sale" src="resource/images/sale.png" alt="Sale"/>
							<div class="prev">
								<a href="product_page.html"><img src="resource/images/product_1.png" alt="" title="" /></a>
							</div><!-- .prev -->
							<h3 class="title">Febreze Air Effects New Zealand Springs</h3>
							<div class="cart">
								<div class="price">
									<div class="vert">
										<div class="price_new" id="price_new">550.00</div>
										<div class="price_old">725.00</div>
									</div>
								</div>
								<a href="#" class="obn"></a>
					...
					<li class="">
						<div class="grid_3 product">
							<div class="prev">
								<a href="product_page.html"><img src="resource/images/product_2.png" alt="" title="" /></a>
							</div><!-- .prev -->
							<h3 class="title">Febreze Air Effects New Zealand Springs</h3>
							<div class="cart">
								<div class="price">
					...
					<li class="">
						<div class="grid_3 product">
							<div class="prev">
								<a href="product_page.html"><img src="resource/images/product_3.png" alt="" title="" /></a>
							</div><!-- .prev -->
							<h3 class="title">Febreze Air Effects New Zealand Springs</h3>
							<div class="cart">
								<div class="price">
					...
					<li class="">
						<div class="grid_3 product">
							<div class="prev">
								<a href="product_page.html"><img src="resource/images/product_4.png" alt="" title="" /></a>
							</div><!-- .prev -->
							<h3 class="title">Febreze Air Effects New Zealand Springs</h3>
							<div class="cart">
								<div class="price">
