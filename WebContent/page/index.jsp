...
<body>
  <div class="container_12">
    ...
    <header id="branding">
      ...
      <div class="grid_6">
		...
		<li class="separator">|</li>
            <li><a href="logininfo.do" > Log In</a></li>
		<li class="separator">|</li>
  ...
  <div class="container_12">
    <div class="grid_12">
        ...
        <div id="slider">
          <div id="slide1">
            <img src="resource/images/content/slide1.jpg" alt="" title="" />
            <div class="slid_text">
          ...
          <div id="slide2">
            <img src="resource/images/content/slide2.jpg" alt="" title="" />
            <div class="slid_text">
          ...
          <div id="slide3">
            <img src="resource/images/content/slide3.jpg" alt="" title="" />
            <div class="slid_text">
      ...
      <div id="top_button">
        <div class="grid_4">
          <a href="#" class="button_block best_price">
            <img src="resource/images/banner1.png" alt="Banner 1"/>
          </a><!-- .best_price -->
        </div><!-- .grid_4 -->

        <div class="grid_4">
          <a href="#" class="button_block new_smells">
            <img src="resource/images/banner2.png" alt="Banner 2"/>
          </a><!-- .new smells -->
        </div><!-- .grid_4 -->

        <div class="grid_4">
          <a href="#" class="button_block only_natural">
            <img src="resource/images/banner3.png" alt="Banner 3"/>
          </a><!-- .only_natural -->
        </div><!-- .grid_4 -->
      ...
      <div class="carousel">
        ...
        <ul id="list_product" class="list_product">
          ...
          <li class="">
            <div class="grid_3 product">
              <div class="prev">
                <a href="product_page.html"><img src="resource/images/product_8.png" alt="" title="" /></a>
              </div><!-- .prev -->
              <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
              <div class="cart">
                <div class="price">
        ...
        <ul id="list_product2" class="list_product">
          <li class="">
            <div class="grid_3 product">
              <img class="sale" src="resource/images/sale.png" alt="Sale"/>
              <div class="prev">
                <a href="product_page.html"><img src="resource/images/product_5.png" alt="" title="" /></a>
              </div><!-- .prev -->
              <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
              <div class="cart">
                <div class="price">
          ...
          <li class="">
            <div class="grid_3 product">
              <img class="sale" src="resource/images/sale.png" alt="Sale"/>
              <div class="prev">
                <a href="product_page.html"><img src="resource/images/product_6.png" alt="" title="" /></a>
              </div><!-- .prev -->
              <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
              <div class="cart">
                <div class="price">
          ...
          <li class="">
            <div class="grid_3 product">
              <div class="prev">
                <a href="product_page.html"><img src="resource/images/product_7.png" alt="" title="" /></a>
              </div><!-- .prev -->
              <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
              <div class="cart">
                <div class="price">
          ...
          <li class="">
            <div class="grid_3 product">
              <img class="sale" src="resource/images/sale.png" alt="Sale"/>
              <div class="prev">
                <a href="product_page.html"><img src="resource/images/produkt_slid1.png" alt="" title="" /></a>
              </div><!-- .prev -->
              <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
              <div class="cart">
                <div class="price">
          ...
          <li class="">
            <div class="grid_3 product">
              <div class="prev">
                <a href="product_page.html"><img src="resource/images/product_9.png" alt="" title="" /></a>
              </div><!-- .prev -->
              <h3 class="title">Febreze Air Effects New Zealand Springs</h3>
              <div class="cart">
                <div class="price">
